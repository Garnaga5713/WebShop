...
using WebbSShop.Data;
using WebbSShop.Models;
using System.Data;
using System.Diagnostics;

namespace WebbSShop.Controllers
{
    public class HomeController : Controller
    {
        ...
        public IActionResult OrderDetail(int id)
        {
            ...
            {
                products = db.OrderDatails.OrderByDescending(s => s.Id).Where(s => s.Id == product.Id);
            }

            detail = db.OrderDatails.Where(x => x.OrderId == id);
            if (detail != null)
            {
                return View(detail);
            }
        ...
        public IActionResult Order()
        {
            ...
            string str_connection = @"Server=(localdb)\MSSQLLocalDB; Database=sprin16; Trusted_Connection=True; MultipleActiveResultSets=true";
